...
export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  keywords: ["共同親権", "共同親権 AI", "共同親権 2026", "共同親権 2026年4月施行", "共同親権制度 施行", "共同親権 計画書", "養育計画書", "養育計画書 テンプレート", "養育計画書 書き方", "養育費合意書", "面会交流 計画書", "養育費 計算", "養育費 月8万円", "法定養育費 2万円", "離婚 親権", "親権計画書 作り方", "調停 準備", "共同親権 単独親権 違い", "面会交流 ルール", "養育費 相場 2026", "kyodo-shinken", "共同親権 弁護士 費用", "共同親権 書類", "改正民法 親権"],
  openGraph: {
    title: TITLE,
    description: DESC,
    url: SITE_URL,
