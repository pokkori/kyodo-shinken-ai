    ...
    <main className="min-h-screen bg-slate-950 text-white px-4 py-16">
      <div className="max-w-2xl mx-auto space-y-8 text-slate-300 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p>本サービスでは、入力いただいた親権関連情報（お子さんの情報・両親の状況等）、決済情報（PAY.JP（PAY.JP株式会社）が管理）、およびCookieによる利用状況を収集します。</p>
        </section>
        <section>
          <h2 className="text-white font-bold mb-2">情報の利用目的</h2>
          <p>収集した情報は、AI生成サービスの提供、サービス改善、および不正利用の防止のためにのみ使用します。</p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>入力いただいた親権関連情報は、ドキュメント生成のためにAnthropicのAPIに送信されます。個人を特定できる形での保存・利用はしません。</p>
        </section>
        <section>
        ...
        <section>
          ...
          <table className="w-full text-left text-xs text-slate-400">
            ...
            <tbody>
              <tr className="border-b border-white/5"><td className="py-2 pr-2">Anthropic（Claude API）</td><td className="py-2 pr-2">AIによるドキュメント生成</td><td className="py-2">ユーザーの入力テキスト（親権関連情報）</td></tr>
              <tr className="border-b border-white/5"><td className="py-2 pr-2">PAY.JP（PAY株式会社）</td><td className="py-2 pr-2">決済処理</td><td className="py-2">決済に必要な情報</td></tr>
        ...
        <section>
          ...
          <p>プライバシーに関するご質問はX(Twitter) @levona_design へのDMまでご連絡ください。</p>
        </section>
      </div>
    </main>
  );
