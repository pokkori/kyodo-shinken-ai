...
export const metadata: Metadata = {
  title: "共同親権チェックリスト｜離婚前・離婚後に確認すべき10項目【2026年4月施行対応】",
  description: "共同親権（2026年4月施行）を選択する前に確認すべき10項目を完全網羅。親権計画書・面会交流・養育費・DV確認まで。弁護士費用を節約して準備できます。",
  keywords: ["共同親権 チェックリスト", "共同親権 確認事項", "共同親権 準備", "離婚 チェックリスト", "共同親権 必要書類", "面会交流 取り決め", "養育費 決め方"],
  openGraph: {
    title: "共同親権チェックリスト｜離婚前・離婚後に確認すべき10項目",
    description: "共同親権を選択する前に確認すべき10項目。親権計画書・面会交流・養育費・DV確認まで完全網羅。",
    url: "https://kyodo-shinken-ai.vercel.app/checklist",
  },
  alternates: { canonical: "https://kyodo-shinken-ai.vercel.app/checklist" },
};
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "headline": "共同親権チェックリスト｜離婚前・離婚後に確認すべき10項目",
      "description": "共同親権（2026年4月施行）を選択する前に確認すべき10項目を完全網羅。",
      "url": "https://kyodo-shinken-ai.vercel.app/checklist",
    ...
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "共同親権を選んだ後で変更できますか？", "acceptedAnswer": { "@type": "Answer", "text": "できます。共同親権から単独親権への変更は、家庭裁判所への「親権者変更」申立で可能です。DVや虐待が認定される場合、裁判所は単独親権に変更する判断を行います。" } },
        { "@type": "Question", "name": "共同親権で最もトラブルになりやすいことは？", "acceptedAnswer": { "@type": "Answer", "text": "最も多いトラブルは「重要事項の決定で合意できない」ことです。転居・進学・医療の同意など両親の合意が必要な事項で意見が割れると、家庭裁判所への申立が必要になります。事前に親権計画書でルールを明確化しておくことが重要です。" } },
        { "@type": "Question", "name": "DV被害者でも共同親権になりますか？", "acceptedAnswer": { "@type": "Answer", "text": "DVや虐待が認定される場合、裁判所は単独親権と判断します。証拠（診断書・警察届出・LINEや写真の記録）を保全し、弁護士または法テラスにご相談ください。" } },
      ],
    },
  ],
};
      ...
      <section className="bg-gradient-to-br from-teal-900 to-teal-700 text-white py-14 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-teal-100 text-base max-w-xl mx-auto mb-6">
            2026年4月施行の改正民法に対応。弁護士に相談する前に自分でできる準備を10のチェック項目で解説します。
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <span className="bg-white/10 border border-white/20 text-white rounded-full px-4 py-1.5 text-sm font-medium">🆓 無料で確認</span>
          </div>
        </div>
      </section>
          ...
          <section key={section.category}>
            ...
            <div className="space-y-4">
              {section.items.map((item) => (
                <div key={item.num} className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-full bg-teal-600 text-white flex items-center justify-center font-black text-sm shrink-0">
                      {item.num}
                    </div>
